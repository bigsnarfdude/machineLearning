...
# encoding: utf-8
"""
Naive Bayes Classifier from scratch as part of the 
Hilary Mason ML Class from 2011
Modified script for comparison with sklearn implementation
"""
